...
if __name__ == "__main__":
	...
	axes_atm_up = plt.scatter(S_range[1:], data_a[1:len(S_range)], s=30, c='#3b41ff', marker='+')
	axes_atm_down = plt.scatter(reverse[:], data_a[len(S_range):], s=15, c='#ce0aff', marker='x')

	axes_surf_up = plt.scatter(S_range[1:], data_s[1:len(S_range)], s=30, c='#5bff45', marker='+')
